  ...
  return (
    <div className="bg-[#F8FAFC] py-16 md:py-20">
      <div className="max-w-3xl mx-auto px-4">
        <h1 className="text-4xl font-bold text-[#0F2044] mb-2">Terms of Service</h1>
        ...
        <div className="space-y-8 text-[#475569] leading-relaxed text-[15px]">
          ...
          <Section title="1. What BrightCert provides">
            ...
            <p className="mt-3 rounded-[8px] border border-[#FDE68A] bg-[#FFFBEB] p-4 text-[#92400E]">
          ...
          <Section title="4. Refunds">
            <p>
              ...
              <a href="mailto:hello@brightcert.co.uk" className="text-[#047857] hover:underline">
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section>
      <h2 className="text-lg font-semibold text-[#0F2044] mb-2">{title}</h2>
      {children}
    </section>
  );
}
